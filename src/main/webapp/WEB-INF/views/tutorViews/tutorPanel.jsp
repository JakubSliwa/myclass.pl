...
<body>
	...
	<div id="sidebar" class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<li class="sub-menu"><a href=""> <i class="fa fa-th"></i> <span>Raporty</span>
			</a></li>
			<li class="sub-menu"><a href=""> <i
					class=" fa fa-bar-chart-o"></i> <span>Finanse</span>
			</a></li>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<c:url value="../sys_school/addexercise" var="newExercise" />
			<div class="row mtbox">
				...
				<div class="col-md-12">
					<div class="content-panel">
						<table class="table table-striped table-advance table-hover">
							...
							<thead>
								<tr>
									<th><i class="fa fa-bullhorn"></i> Uczeń</th>
									<th class="hidden-phone"><i class="fa fa-question-circle"></i>
										Zadanie</th>
									<th><i class="fa fa-bookmark"></i> Odpowiedź</th>
									<th><i class=" fa fa-edit"></i> Do kiedy?</th>
									<th></th>
								</tr>
							</thead>
							<tbody>
