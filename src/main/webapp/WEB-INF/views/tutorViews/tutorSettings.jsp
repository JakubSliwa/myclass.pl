			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb">
							<i class="fa fa-angle-right"></i> Zmień swoje dane
						</h4>
							...
							<div class="form-group" data-validate="Wprowadź email">
								...
								<div class="col-sm-10">
									<form:input path="email" class="form-control"
										placeholder="Podaj swój nowy email" type="email" />
								</div>
								<form:errors path="email" />
							</div>
							<div class="form-group" data-validate="Wprowadź hasło">
								<label class="col-sm-2 col-sm-2 control-label">Hasło</label>
								<div class="col-sm-10">
									<form:input path="password" class="form-control"
										placeholder="Podaj nowe hasło" type="password" />
								</div>
								<form:errors path="password" />
							</div>
							<input class="btn btn-primary" type="submit"
								value="Zmień swoje dane">
						</form:form>
					</div>
				</div>
			</div>
