...
<title>Myclass.pl - błąd zapraszania studenta</title>
...
<body>
	...
	<c:url value="../sys_school/invitestudent" var="invite" />
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				...
				<div class="container-login100-form-btn">
					<a class="login100-form-btn" href="${invite}">Dokończ dodawanie
						nowego studenta</a>
				</div>
